...
Nothing. TrueLine has no accounts, no analytics, no advertising, no third-party SDKs, and makes no network connections. The app's App Store privacy label is "Data Not Collected," and this page is the long version of the same fact.
...
TrueLine asks for camera access to record your throws and photo library access to import existing clips. That footage is used solely for the analysis you run on it, on your device. Denying either permission disables only the corresponding feature.

## Children's privacy

TrueLine collects no data from anyone, including children.
